                ...
                string createTablesQuery = @"
                    ...
                    BEGIN
                        CREATE TABLE purchases (
                            ...
                            FOREIGN KEY (MovieID) REFERENCES movies(MovieID) ON DELETE NO ACTION -- Убрали каскадное удаление
                        );
                    END;

                    -- Создание таблицы purchased_seats
                    ...
                    BEGIN
                        CREATE TABLE purchased_seats (
                            ...
                            FOREIGN KEY (SeatID) REFERENCES seats(SeatID) ON DELETE NO ACTION
                        );
                    END;
            ";
